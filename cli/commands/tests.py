...
def tests(ctx: click.Context) -> None:
    ...
    from cli.tests.discover import load_test_catalog
    from cli.tests.interactive import run_interactive_picker
...
def run_openclaw_synthetic_suite(scenario: str, output_json: bool) -> None:
    ...
    from cli.tests.discover import OPENCLAW_SYNTHETIC_SCENARIOS_DIR
...
def run_test(test_id: str, dry_run: bool) -> None:
    ...
    from cli.tests.runner import find_test_item, run_catalog_item
