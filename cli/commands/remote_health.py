...
from platform.terminal.theme import BRAND, DIM, ERROR, HIGHLIGHT, TEXT, WARNING
...
def _save_remote_base_url(client: RemoteAgentClient) -> None:
    from cli.wizard.store import save_remote_url

    save_remote_url(client.base_url)

    from cli.wizard.store import load_named_remotes, save_named_remote
...
def _render_remote_health_report(report: dict[str, Any]) -> None:
    ...
    from cli.interactive_shell.ui.health_view import status_badge
