...
from cli.interactive_shell.command_registry.agents import COMMANDS as AGENTS_COMMANDS
from cli.interactive_shell.command_registry.alerts import COMMANDS as ALERTS_COMMANDS
...
from cli.interactive_shell.command_registry.help import COMMANDS as HELP_COMMANDS
...
from cli.interactive_shell.command_registry.model import COMMANDS as MODEL_COMMANDS
from cli.interactive_shell.command_registry.model import (
    switch_llm_provider,
...
from cli.interactive_shell.command_registry.session_cmds import COMMANDS as SESSION_COMMANDS
...
def dispatch_slash(
    ...
    *,
    ...
    try:
        ...
        if stripped == "/":
            from cli.interactive_shell.command_registry.help import _cmd_help
