...
from cli.interactive_shell.runtime import (
...
def start_background_text_investigation(
    *,
    ...
    from cli.investigation import run_investigation_for_session_background
...
def start_background_template_investigation(
    *,
    ...
    from cli.investigation import run_sample_alert_for_session_background
