...
These instructions apply to `cli/interactive_shell/harness/` and all
...
- Harness tests must be co-located under `cli/interactive_shell/harness/tests/`.
- Do **not** move routing tests back under `tests/cli/interactive_shell/harness/`.
- When adding a new harness-phase test file, place it under
  `cli/interactive_shell/harness/tests/` and keep routing test fixtures
  under that subtree.
...
| --- | --- | --- |
| `cli/interactive_shell/harness/tests/test_routing_scenarios.py` | Harness package owners | Canonical runner: deterministic routing, live classification, action planning, turn-execution oracles |
| `cli/interactive_shell/harness/tests/test_routing_fixture_integrity.py` | Harness package owners | Scenario-tree/schema/no-mocks guardrails |
| `cli/interactive_shell/harness/tests/scenario_loader.py` | Harness package owners | Load `scenarios/<behavior_class>/<id>/{scenario.yml,answer.yml}` |
| `cli/interactive_shell/harness/tests/scenarios/**/scenario.yml` | Harness package owners | Input world: prompt, session, capabilities, intent metadata |
| `cli/interactive_shell/harness/tests/scenarios/**/answer.yml` | Harness package owners | Expected behavior: route, policy, planned/executed actions, response contract |
...
- Keep deterministic routing contracts (`test_routing_scenarios.py::test_deterministic_routing` and
  ...
  (`pytest cli/interactive_shell/harness/tests/ -m "not live_llm"`), which
