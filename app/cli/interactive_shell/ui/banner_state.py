...
:func:`app.cli.interactive_shell.ui.banner._build_ambient_right_column`.
"""
...
from app.cli.interactive_shell.ui.theme import BRAND, DIM, HIGHLIGHT, SECONDARY, WARNING
