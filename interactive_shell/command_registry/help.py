...
def _raw_help_sections() -> list[HelpSection]:
    from interactive_shell.command_registry.agents import COMMANDS as AGENTS_CMDS
    from interactive_shell.command_registry.alerts import COMMANDS as ALERTS_CMDS
    ...
    from interactive_shell.command_registry.integrations import COMMANDS as INT_CMDS
    from interactive_shell.command_registry.investigation import COMMANDS as INV_CMDS
    from interactive_shell.command_registry.model import COMMANDS as MODEL_CMDS
    from interactive_shell.command_registry.privacy_cmds import COMMANDS as PRIVACY_CMDS
    from interactive_shell.command_registry.rca_cmds import COMMANDS as RCA_CMDS
    from interactive_shell.command_registry.session_cmds import COMMANDS as SESSION_CMDS
    from interactive_shell.command_registry.settings_cmds import (
        COMMANDS as SETTINGS_CMDS,
    )
    from interactive_shell.command_registry.system import COMMANDS as SYS_CMDS
    from interactive_shell.command_registry.tasks_cmds import COMMANDS as TASK_CMDS
    from interactive_shell.command_registry.theme import COMMANDS as THEME_CMDS
    from interactive_shell.command_registry.tools_cmds import COMMANDS as TOOLS_CMDS
    from interactive_shell.command_registry.watch_cmds import COMMANDS as WATCH_CMDS
