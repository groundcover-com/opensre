...
from cli.interactive_shell.ui import tool_catalog
from cli.interactive_shell.ui.tool_catalog import (
    ToolCatalogEntry,
...
class TestListToolsSlashCommand:
    ...
    def test_list_tools_prints_grouped_catalog(self) -> None:
        ...
        with patch(
            "cli.interactive_shell.command_registry.tools_cmds.build_tool_catalog",
            return_value=fake,
        ):
